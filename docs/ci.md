...
|-----|--------------|-----|
| `backend-tests` | `pip install -r requirements/minimal-requirements.txt` + `pytest tests/` | Catches "tests pass with full dev deps but break in the slim Docker image" regressions |

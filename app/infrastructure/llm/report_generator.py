...
class LLMReportGenerator(ReportGenerator):
    ...
    def _build_prompt(
        ...
        user_prompt = (
            ...
            "in this order, with NO content before the H1):\n\n"
            "# <report title>\n"
            "<-- THIS LINE IS REQUIRED. The PDF generator and the\n"
            "    React UI both extract the report title from the\n"
            "    FIRST line of your output. If you omit this line,\n"
            "    the user sees the generic placeholder\n"
            "    'Biomedical Research Report' instead of a useful\n"
            "    per-report title. The title should be a concise\n"
            "    (5-15 word) description of the topic. Examples:\n"
            "        # Plasma p-tau217 as a Diagnostic Marker for AD\n"
            "        # Tau Biomarkers in AD: A Synthesis of Recent Evidence\n"
            "        # Blood-Based Biomarkers for Alzheimer's: 2024 Update\n"
            "    DO NOT prefix the title with a number, a date, a\n"
            "    question mark, or any text -- just the bare title.\n\n"
            "## Executive Summary\n"

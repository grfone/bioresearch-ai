...
communicating with StepFun language models.
...
class StepFunProvider(BaseLLMProvider):
    """
    StepFun implementation of the LLM provider.
    """
    ...
    def generate(
        ...
        """
        Generate a completion using StepFun.
        ...
        raise NotImplementedError(
            "StepFunProvider.generate() has not been implemented yet."
        )
